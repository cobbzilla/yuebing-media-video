...
export const mediaDriver = {
    applyProfile: (downloaded, profile, outDir, sourcePath, conn, analysisResults) => __awaiter(void 0, void 0, void 0, function* () {
        if (profile.noop)
        ...
        return yield OP_MAP[profile.operation](downloaded, profile, `${outDir}/${profile.operation}.${profile.ext}`, sourcePath, conn, analysisResults);
    }),
