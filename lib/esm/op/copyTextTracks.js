...
export const copyTextTracks = (infile, profile, outDir, sourcePath, conn) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (let i = 0; i < dirFiles.length; i++) {
        ...
        if (m && m[0] === filename) {
            ...
            if (!destOutfileBase.match(textTrackRegex)) {
                console.warn(`copyTextTracks: invalid destOutfileBase (${destOutfileBase}) did not match textTrackRegex=${textTrackRegex}`);
                continue;
            }
